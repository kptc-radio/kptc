...
QString ConfigData::getEditPort() {
	return this->getData(Types::PORTDEVICE_EDIT);
...
QString ConfigData::getPortSpeed() {
	return this->getData(Types::PORTSPEED);
...
QString ConfigData::getCall() {
	return this->getData(Types::CALL);
...
QString ConfigData::getSelCall() {
	return this->getData(Types::SELCALL);
...
bool ConfigData::firststart() {
	QString s = this->getData(Types::FIRSTSTART);
...
void ConfigData::setAwayMsg(bool set,const QString &msg) {
	this->setData(Types::USEAWAYMSG, this->boolToString(set));
...
QString ConfigData::getCQPactor() {
	return this->getData(Types::PACTOR);
...
QString ConfigData::getCQAmtor() {
	return this->getData(Types::AMTOR);
...
QString ConfigData::getCQRTTY() {
	return this->getData(Types::RTTY);
...
QString ConfigData::getCQPSK31() {
	return this->getData(Types::PSK31);
...
QString ConfigData::getName() {
	return this->getData(Types::NAME);
...
QString ConfigData::getLogoutPath () {
	return this->getData(Types::PATH_LOGOUT);
